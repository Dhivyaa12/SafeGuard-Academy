...
export const modules = [
  ...
  },
  {
    ...
    icon: Zap,
    lessons: [
      { title: 'Common Electrical Hazards', duration: '6 min', content: 'Identifying common electrical hazards is the first step in prevention. This includes overloaded outlets, frayed or damaged cords, improper use of extension cords, and placing combustibles near heat-generating appliances. Regular visual inspections of electrical equipment can prevent many fires before they start.' },
      { title: 'Using a Class C Extinguisher', duration: '5 min', content: 'Electrical fires require a Class C fire extinguisher. These extinguishers use non-conductive agents like carbon dioxide or dry chemical powders that won\'t create a shock hazard. Never use water (Class A) or other conductive agents on a live electrical fire.' },
      { title: 'Emergency Power-off Procedures', duration: '4 min', content: 'If it\'s safe to do so, the first step in fighting an electrical fire is to de-energize the equipment by unplugging it or shutting off the power at the circuit breaker. This removes the electrical current as a source of ignition and may extinguish the fire on its own. It also makes it safer to use other types of extinguishers if necessary.' },
    ],
    quiz: [
        {
  ...
  },
  {
    ...
    icon: Users,
    lessons: [
      { title: 'Communicating with Guests', duration: '10 min', content: 'Clear, calm, and authoritative communication is vital during an evacuation. Use the PA system, go door-to-door, and give concise instructions. Direct guests to the nearest safe exit and assembly point. Avoid causing panic.' },
      { title: 'Assisting Guests with Disabilities', duration: '12 min', content: 'It is a priority to have a plan for guests who may need extra help, such as the elderly, or those with mobility, hearing, or vision impairments. Staff should be trained on how to assist them, which may involve using evacuation chairs or directing them to areas of refuge until emergency services arrive. Never use elevators during a fire.' },
      { title: 'Assembly Point Management', duration: '8 min', content: 'Once guests are evacuated, they must gather at a designated assembly point a safe distance from the building. Staff should take a head count if possible, keep guests calm, provide information, and prevent them from re-entering the building until it is declared safe by the fire department.' },
    ],
    quiz: [
        {
  ...
  },
  {
    ...
    lessons: [
      { title: 'Types of Extinguishers (A, B, C, D, K)', duration: '10 min', content: 'Class A is for combustibles like wood/paper. Class B for flammable liquids like grease/gasoline. Class C for electrical fires. Class D for combustible metals. Class K for commercial kitchen cooking oils. Most hotels use multi-purpose ABC extinguishers.' },
      { title: 'The P.A.S.S. Technique', duration: '5 min', content: 'P.A.S.S. is an acronym for using an extinguisher: PULL the pin. AIM the nozzle at the base of the fire. SQUEEZE the lever slowly and evenly. SWEEP the nozzle from side-to-side.' },
      { title: 'Hands-on AR Simulation', duration: '15 min', content: 'Use our Augmented Reality feature to practice the P.A.S.S. technique on a simulated fire. This provides a safe, interactive way to build muscle memory and confidence without the danger of a real fire.' },
    ],
    quiz: [
        {
